  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li><a href='https://facebook.github.io/react/'>React</a> for
          client-side code
        </li>
        <li><a href='http://getbootstrap.com/'>Bootstrap</a> for layout and
          styling
        </li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Development server integration</strong>. In development
        ...
        <li><strong>Efficient production builds</strong>. In production mode,
          development-time features are disabled, and your <code>dotnet
            publish</code> configuration produces minified, efficiently bundled
          JavaScript files.
        </li>
      </ul>
      <p>The <code>ClientApp</code> subdirectory is a standard React application
        ...
        such as <code>npm test</code> or <code>npm install</code>.</p>
      <div className="dsm">
        <Button variant={"outline-primary"} titleText={`Primary Button`} />
      </div>
    </div>
  );
}
